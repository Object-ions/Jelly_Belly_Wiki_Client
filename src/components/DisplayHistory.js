      ...
      <div className="history-grid">
        ...
        <div className="item-wrapper">
          <div className="item">
            <h4>1976</h4>
            <p>
              The first Jelly Belly jelly beans are introduced with flavors like
              Root Beer, Green Apple, Licorice, Cream Soda, Lemon, Tangerine,
              Very Cherry, and Grape.
            </p>
          </div>
          <FontAwesomeIcon icon={faArrowRight} />
        </div>
        ...
        <div className="item-wrapper">
          <div className="item">
            <h4>2014</h4>
            <p>Draft Beer flavor, inspired by Hefeweizen ale, is introduced.</p>
          </div>
          <FontAwesomeIcon icon={faArrowRight} />
        </div>
